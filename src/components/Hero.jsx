...
<NavLink
 ...
 Log in <span aria-hidden="true">&rarr;</span>
      ...
      <div className="relative isolate px-6 pt-14 lg:px-8 ">
        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56 -mt-30">
          ...
          <div className="text-center">
            ...
            Struggling to manage your spending? Our expense tracker helps you stay organized, save more, and stress less.
            </p>
